...
if(modals.length) {
  ...
  const btnPopups = Array.prototype.slice.call( document.querySelectorAll('.btn-popup') );

  btnPopups.forEach((btn, i) => {
    btn.setAttribute("data-modal-open", `modal-${i}`);
    modals[i].setAttribute("id", `modal-${i}`);
